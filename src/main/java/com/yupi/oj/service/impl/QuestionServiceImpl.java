...
import com.yupi.oj.utils.ValidationUtils;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question> implements QuestionService {
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        // 有参数则校验
        ValidationUtils.validateStringMaxLength(title, 80, "标题过长");
        ValidationUtils.validateStringMaxLength(content, 8192, "内容过长");
        ValidationUtils.validateStringMaxLength(answer, 8192, "答案过长");
        ValidationUtils.validateStringMaxLength(judgeCase, 8192, "判题用例过长");
        ValidationUtils.validateStringMaxLength(judgeConfig, 8192, "判题配置过长");
    }
